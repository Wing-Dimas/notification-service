...
const ACCEPTED_FILE_TYPES = [...ACCEPTED_IMAGE_TYPES, ...ACCEPTED_VIDEO_TYPES, ...ACCEPTED_DOCUMENT_TYPES];
...
export const editMessageFormSchema = z.object({
  ...
  file: z
    ...
    .refine(
      ...
      {
        message: "Format file tidak didukung. Harap upload file gambar, video, atau dokumen.",
      }
    ),
});
