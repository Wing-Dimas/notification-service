...
function useTooltipContext(_componentName: string): TooltipContextValue {
...
>((props, _forwardedRef) => {
  ...
  return createPortal(
    isMobile ? (
      <div
        className={cn(
          "fixed h-fit z-60 w-fit rounded-lg  border p-3",
          isDarkTheme
      ...
      <div
        ref={tooltipRef}
        className={cn(
          "bg-white border border-zinc-200 px-3.5 py-2 rounded-sm fixed z-50",
          isDarkTheme ? "bg-zinc-900 border-zinc-800" : "",
        )}
